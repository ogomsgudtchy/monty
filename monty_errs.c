...
/**
 * err - prints appropiate err messages determined by their err code.
 ...
 * (8) => When stack is too short for ops.
 */
 ...
 * @error_code: Err codes are the following:
 * (6) => When stack it empty for pint.
 * (7) => When stack it empty for pop.
 * (8) => When stack is too short for ops.
 * (9) => Division by zero.
